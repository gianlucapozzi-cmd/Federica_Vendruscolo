  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-4 right-3 sm:top-6 sm:right-6 z-20"
      >
        <a
          href="https://instagram.com/federicavendruscolo.pt"
          target="_blank"
          rel="noopener noreferrer"
          className="group flex items-center gap-1.5 sm:gap-2 bg-white/10 backdrop-blur-sm rounded-full px-2.5 py-1.5 sm:px-4 sm:py-2 hover:bg-white/20 transition-all duration-300"
        >
          <svg
          ...
          <span className="text-white text-[11px] sm:text-sm font-medium group-hover:text-accent transition-colors duration-300">
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="mb-6">
            <img 
              ...
              className="w-[91px] h-[91px] sm:w-24 sm:h-24 mx-0 sm:mx-auto rounded-full object-cover bg-transparent"
              style={{ 
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="inner-content group flex items-center gap-3 text-xl px-10 py-5 sm:px-12 sm:py-6 relative overflow-hidden"
            onClick={() => {
