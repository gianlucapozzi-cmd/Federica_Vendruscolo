  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-4 left-1/2 transform -translate-x-1/2 lg:left-auto lg:transform-none lg:top-6 lg:right-6 z-20"
      >
        <a
          href="https://instagram.com/federicavendruscolo.pt"
          target="_blank"
          rel="noopener noreferrer"
          className="group flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-3 py-1.5 lg:px-4 lg:py-2 hover:bg-white/20 transition-all duration-300"
        >
          <svg
            className="w-4 h-4 lg:w-5 lg:h-5 text-white group-hover:scale-110 transition-transform duration-300"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          <span className="text-white text-xs lg:text-sm font-medium group-hover:text-accent transition-colors duration-300">
